...
## https://github.com/stefansavev/elasticsearch-custom-similarity-example/blob/master/deploy-script.sh
...
JAR_FILE="ignore-idf-similarity-plugin-0.1-SNAPSHOT.jar" #name of the jar file
PLUGIN_NAME="ignore-idf-similarity-plugin"
